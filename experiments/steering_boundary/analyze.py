...
def steering_vectors(contrast_X, contrast_y):
    """Per layer: mean(trait) - mean(neutral). Unnormalised, so a coefficient of
    1.0 means "one full persona shift" — the usual CAA convention."""
...
def main():
    ...
    steer = {**steer_arrays, "trait": steer_meta["trait"], "eval_set": steer_meta["eval_set"]}
